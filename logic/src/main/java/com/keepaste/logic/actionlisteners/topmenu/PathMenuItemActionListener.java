...
public class PathMenuItemActionListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        String pathValue = JOptionPane.showInputDialog(Application.getContext().getGui(),
                "Value of the PATH environment variable to be used when running parameter commands",
                Application.getContext().getModelSettings().getPath());
